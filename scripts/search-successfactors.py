#!/usr/bin/env python3
# nj-pay-hub/scripts/search-successfactors.py
# NJ L.2019 c.225 — salary range required in all postings (eff. Jun 1 2020)

LOG_FILE  = "/Users/clawii/nj-pay-hub/scripts/successfactors.log"
LOCK_FILE = "/Users/clawii/nj-pay-hub/scripts/.successfactors.lock"
...
SEED_PORTALS = load_successfactors_seeds('nj')
REGION_TERMS    = ['new jersey', 'newark', 'jersey city', 'trenton', 'princeton', 'parsippany', 'rahway', 'kenilworth', 'new brunswick', 'morris plains', 'woodbridge', 'florham park', 'bridgewater', 'east hanover', 'whippany', ', nj,', ', nj ']
NON_REGION_TERMS = ['new york', 'pennsylvania']
CITY_MAP        = {'newark': 'Newark, NJ', 'jersey city': 'Jersey City, NJ', 'trenton': 'Trenton, NJ', 'princeton': 'Princeton, NJ', 'parsippany': 'Parsippany, NJ', 'rahway': 'Rahway, NJ', 'new brunswick': 'New Brunswick, NJ', 'bridgewater': 'Bridgewater, NJ', 'florham park': 'Florham Park, NJ'}
DEFAULT_LOCATION = 'New Jersey, NJ'
SALARY_MIN      = 30000
SALARY_MAX      = 1000000
