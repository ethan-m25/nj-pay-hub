#!/usr/bin/env python3
"""
nj-pay-hub/scripts/search-amazon.py
Amazon Jobs scraper — NJ edition.

Strategy: Query amazon.jobs/en/search.json for NJ locations.
...
LOG_FILE  = os.path.expanduser("~/nj-pay-hub/scripts/amazon.log")
LOCK_FILE = os.path.expanduser("~/nj-pay-hub/scripts/.amazon.lock")
...
QUERY_LOCATIONS = ['Newark, New Jersey, USA', 'Jersey City, New Jersey, USA', 'Virtual Location - New Jersey, USA']

REGION_TERMS = ['new jersey', 'newark', 'jersey city', 'princeton', 'trenton', 'camden', ', nj']

CITY_MAP = {'newark': 'Newark, NJ', 'jersey city': 'Jersey City, NJ', 'princeton': 'Princeton, NJ'}
...
def main():
    ...
    log("=== Amazon Jobs NJ scraper started ===")
    ...
    log(f"=== Amazon NJ scraper complete: {total_found} new jobs ===")
    return 0
